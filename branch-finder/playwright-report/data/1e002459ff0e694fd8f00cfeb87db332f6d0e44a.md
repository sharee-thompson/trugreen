...
- Name: functional/branch-finder/drupal-branch-finder-navigation.spec.ts >> Drupal header branch finder navigation >> search button routes from /loyalty/fall1/terms-and-conditions to its local branch
...
Received string:  "https://dev-trugreen.com/loyalty/fall1/terms-and-conditions?automation=true"
Timeout: 20000ms

Call log:
  - Expect "toHaveURL" with timeout 20000ms
    3 × unexpected value "https://dev-trugreen.com/loyalty/fall1/terms-and-conditions?automation=true"
    - waiting for" https://dev-trugreen.com/loyalty/fall1/terms-and-conditions?automation=true" navigation to finish...
    - navigated to "https://dev-trugreen.com/loyalty/fall1/terms-and-conditions?automation=true"
    35 × unexpected value "https://dev-trugreen.com/loyalty/fall1/terms-and-conditions?automation=true"
...
- main:
  - main:
    ...
    - paragraph: You may request to redeem the Offer by following the instructions in the email sent to you, specifically that customers may choose to apply the EasyPay Offer to their next invoiced service or the PrePay Offer to a full prepayment of future service. Customers must provide account information including name, address, phone, and customer number, as well as their choice of EasyPay Offer or PrePay Offer via the form link provided in the promotional email. You will receive an email confirmation once the Offer has been successfully applied to your account. After receiving the confirmation, customers selecting the PrePay Offer must contact TruGreen to process their prepayment, which will reflect the $20 discount in addition to any other prepay discounts for which they may be eligible.
    ...
    - list:
      - listitem:
        - strong:
          - emphasis: Offers
    - paragraph: The EasyPay Offer, a one-time $10 discount off a future TruGreen service, can be applied to a future payment of an existing TruGreen program. The PrePay Offer, a one-time $20 discount off a full prepayment of future TruGreen service, can be applied to a future prepayment of an existing TruGreen program. Regardless, the Offer cannot be applied retroactively to a previous payment, but can be combined with other discounts. One Offer per customer.
