...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 390px by 2246px, received 390px by 3804px. 1087933 pixels (ratio 0.74 of all image pixels) are different.

  Snapshot: fullpage-registration.png

Call log:
  - Expect "toHaveScreenshot(fullpage-registration.png)" with timeout 5000ms
  ...
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 390px by 778px, received 390px by 2246px. 533075 pixels (ratio 0.61 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e20]:
    - generic [ref=e22]:
      ...
      - generic [ref=e23]:
        - generic [ref=e25]:
          - heading "Registration" [level=1] [ref=e26]
          - paragraph [ref=e27]: In order to register your account, you’ll need your TruGreen customer number, which can be found on your service summary, post-service email, billing statement or the welcome email you received when you first signed up for service.
          - generic [ref=e28]: All fields are required
          - generic [ref=e30]:
            - generic [ref=e31]:
              - generic [ref=e32]: Customer number (10 digits)
              - textbox "Customer number (10 digits)" [ref=e33]
              - generic [ref=e34] [cursor=pointer]: "?"
            - generic [ref=e35]:
              - generic [ref=e36]: Billing ZIP code (5 digits)
              - textbox "Billing ZIP code (5 digits) Zip Code*" [ref=e37]:
                - /placeholder: Billing ZIP code (5 digits)
            - generic [ref=e38]:
              - generic [ref=e39]: Email address
              - textbox "Email address" [ref=e40]
            - generic [ref=e41]:
              - generic [ref=e42]: Confirm email address
              - textbox "Confirm email address" [ref=e43]
            - generic [ref=e44]:
            ...
            - generic [ref=e47]:
              - text: "Password must:"
              - list [ref=e48]:
                - listitem [ref=e49]: Be 8-20 characters
                - listitem [ref=e50]: Include at least one number and capital letter
                - listitem [ref=e51]: "May only contain special characters: - @ _ ! # $"
            - generic [ref=e52]:
          ...
          - generic [ref=e56]:
            ...
            - link "Sign In" [ref=e57]:
              - /url: /my-account/login
        - generic [ref=e60]:
          - heading "Need login assistance?" [level=2] [ref=e62]
          - generic [ref=e63]:
            - generic [ref=e64]:
