...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 390px by 7662px, received 390px by 7736px. 128880 pixels (ratio 0.05 of all image pixels) are different.
