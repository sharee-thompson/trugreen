async (page) => {
  ...
  const urls = [
    'http://localhost:8080/',
    'http://localhost:8080/home-a',
    'http://localhost:8080/home-b',
    'http://localhost:8080/home-c',
    'http://localhost:8080/local-lawn-care',
    'http://localhost:8080/lawn-care',
    'http://localhost:8080/why-choose-trugreen/testimonials-and-ratings',
    'http://localhost:8080/aftercare',
    'http://localhost:8080/lawn-care-101',
    'http://localhost:8080/lawn-care-101/learning-center',
    'http://localhost:8080/lawn-care-101/faqs',
    'http://localhost:8080/lawn-care-101/learning-center/grasses/brown-patch',
    'http://localhost:8080/about/terms',
    'http://localhost:8080/about/privacy-policy',
    'http://localhost:8080/about/sms-terms',
    'http://localhost:8080/about/california-privacy-policy',
    'http://localhost:8080/service-terms-and-conditions'
  ];
