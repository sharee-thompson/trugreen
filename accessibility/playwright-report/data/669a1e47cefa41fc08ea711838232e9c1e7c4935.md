...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.1 (foreground color: #73c573, background color: #ffffff, font size: 13.5pt (18px), font weight: bold). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 2.1 (foreground color: #73c573, background color: #ffffff, font size: 13.5pt (18px), font weight: bold). Expected contrast ratio of 4.5:1",
+         "html": "<h5 class=\"accordion\">About US</h5>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".col-md-2:nth-child(1) > .mob-border > h5",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<body style=\"background-color:white\">",
+                 "target": Array [
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/newsroom/executive-staff#about\">About TruGreen</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".col-md-2:nth-child(1) > .mob-border > .panel.list-unstyled > li:nth-child(1) > a",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/newsroom/executive-staff\">Executive Staff</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"executive-staff\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/newsroom\">Newsroom</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"newsroom\"]",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"https://www.trugreenjobs.com\">Careers</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"www.trugreenjobs.com\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.1 (foreground color: #73c573, background color: #ffffff, font size: 13.5pt (18px), font weight: bold). Expected contrast ratio of 4.5:1",
+         "html": "<h5 class=\"accordion\">Our Services</h5>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".col-md-3:nth-child(2) > .mob-border > h5",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/products-and-services\">Lawn Care Plan Comparison</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "li:nth-child(1) > a[href$=\"products-and-services\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/products-and-services/trushrub-tree-and-shrub-care\">Tree &amp; Shrub Plan Overview</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".col-md-3:nth-child(2) > .mob-border > .panel.list-unstyled > li:nth-child(2) > a",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/pests-products-and-services\">Pest Control Plan Comparison</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href=\"/pests-products-and-services\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/local-lawn-care\">Branch Finder</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"local-lawn-care\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.1 (foreground color: #73c573, background color: #ffffff, font size: 13.5pt (18px), font weight: bold). Expected contrast ratio of 4.5:1",
+         "html": "<h5 class=\"accordion\">Resources</h5>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".col-md-2:nth-child(3) > .mob-border > h5",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/lawn-care-101/faqs\">FAQs</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"faqs\"]",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/military-discount\">Military Discount</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/lawn-care-101/learning-center\">Learning Center</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/lawn-care-101/blog\">Blogs</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"blog\"]",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/service-terms-and-conditions\">Service Terms and Conditions</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href=\"/service-terms-and-conditions\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.1 (foreground color: #73c573, background color: #ffffff, font size: 13.5pt (18px), font weight: bold). Expected contrast ratio of 4.5:1",
+         "html": "<h5 class=\"accordion\">For new service</h5>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "#block-footerrightsidesecondblock > .mob-border > h5",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a id=\"home-getstarted\" data-bs-target=\"#lead-modal\" data-bs-toggle=\"modal\" href=\"javascript:throw new Error('React has blocked a javascript: URL as a security precaution.')\">Get a Call Back</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "#home-getstarted",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.1 (foreground color: #73c573, background color: #ffffff, font size: 13.5pt (18px), font weight: bold). Expected contrast ratio of 4.5:1",
+         "html": "<h5 class=\"accordion\">For our Customer</h5>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "#block-footerrightsidethirdblock > .mob-border > h5",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/my-account/login\">Account Login &amp; Register</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"login\"]",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"sms:18887813135;?&amp;body=Hello!%20I%20need%20some%20assistance%20with%20my%20TruGreen%20account.\">Text: MYLAWN (695296)</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "#block-footerrightsidethirdblock > .mob-border > .panel.list-unstyled > li:nth-child(3) > a",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/customer-support\">Customer Support</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/pay-your-bill\">Pay My Bill </a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/about/sms-terms\">SMS Terms and Conditions</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"sms-terms\"]",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/about/terms\">Terms and Conditions</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "li:nth-child(2) > a[href$=\"terms\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/about/privacy-policy\">Privacy Policy</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "li:nth-child(3) > a[href$=\"privacy-policy\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/about/california-privacy-policy\">California Privacy Notice</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".col-md-8 > ul > li:nth-child(4) > a",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 1.82 (foreground color: #ffb034, background color: #ffffff, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"/about/privacy-policy#additionalStatePrivacyRights\" style=\"display: flex;\">Your Privacy Choices<img alt=\"privacyoptions\" src=\"/images/footer/privacyoptions1.svg\" data-cdn-processed-src=\"/images/footer/privacyoptions1.svg\"></a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".col-md-8 > ul > li:nth-child(5) > a",
+         ],
+       },
+     ],
+     "tags": Array [
    ...
    - dialog "Privacy" [ref=e515]:
      - generic [ref=e517]:
        - generic [ref=e520]:
          ...
          - link "More information about your privacy, opens in a new tab" [ref=e523]:
            - /url: https://www.trugreen.com/about/california-privacy-policy
            - text: California Privacy Policy
        - generic [ref=e525]:
          - button "Cookie Settings, Opens the preference center dialog" [ref=e526] [cursor=pointer]: Cookie Settings
          - button "Reject All" [ref=e527] [cursor=pointer]
          - button "Accept All Cookies" [ref=e528] [cursor=pointer]
