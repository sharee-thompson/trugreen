...
- Name: functional/homepage/homepage.spec.ts >> TruGreen homepage regression >> comparison section contrasts TruGreen, DIY and Other Guys
- Location: tests/functional/homepage/homepage.spec.ts:273:9
...
Call log:
  - waiting for locator('main').first() to be visible
